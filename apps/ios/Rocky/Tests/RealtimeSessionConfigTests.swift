...
final class RealtimeSessionConfigTests: XCTestCase {
    ...
    func testER2SetupReusesThePersonaAndConvertsToolsToBlockingGeminiDeclarations() throws {
        ...
        XCTAssertEqual(vad["disabled"] as? Bool, false)
        XCTAssertEqual(vad["startOfSpeechSensitivity"] as? String, "START_SENSITIVITY_HIGH")
        XCTAssertEqual(vad["endOfSpeechSensitivity"] as? String, "END_SENSITIVITY_HIGH")
        XCTAssertEqual(vad["prefixPaddingMs"] as? Int, 200)
        XCTAssertEqual(vad["silenceDurationMs"] as? Int, 600)
